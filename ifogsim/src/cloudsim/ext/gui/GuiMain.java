...
import cloudsim.ext.gui.screens.ConfigureSimulationPanel1;
...
//private static final String CMD_ABOUT = "About";
	...
	private ConfigureSimulationPanel1 configScreen;
	...
	private void showConfigureScreen(){
		...
		if (configScreen == null){
			configScreen = new ConfigureSimulationPanel1(simulation, this);
...
//	}
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getActionCommand().equals(CMD_CONFIGURE_SIMULATION)){			
			...
			System.exit(0);
		} else if (e.getActionCommand().equals(ConfigureSimulationPanel1.CMD_DONE_CONFIGURATION)){
			if (configScreen.isValidConfiguration()){
				showHomeScreen();
			}
		} else if (e.getActionCommand().equals(ConfigureSimulationPanel1.CMD_CANCEL_CONFIGURATION)){
			showHomeScreen();
