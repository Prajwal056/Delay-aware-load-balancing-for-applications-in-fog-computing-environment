...
public interface Constants {
	...
	final String DEFAULT_USER_BASE_NAME = "task1";
	...
	final String BROKER_POLICY_OPTIMAL_RESPONSE = "optimize response time";
	final String BROKER_POLICY_DYNAMIC = "Reconfigurable Dynamic";
        final String FUZZY_LOGIC = "Fuzzy";

	final String LOAD_BALANCE_POLICY_RR = "RoundRobin";
	final String LOAD_BALANCE_ACTIVE = "ActiveMonitoring ";
	//final String Earliest_Deadline_First = "EDF";
